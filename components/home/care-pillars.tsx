  ...
  return (
    <section aria-labelledby="como-funciona-titulo" className="py-16 md:py-20">
      <div className="mx-auto w-full max-w-[1200px] px-4 md:px-8">
        <h2 id="como-funciona-titulo" className="text-3xl font-bold leading-tight tracking-[-0.02em] text-tc-gray-900 md:text-4xl">
          Como funciona
        </h2>
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <article className="tc-card">
            ...
            <h3 className="mt-3 text-lg font-semibold text-tc-gray-900">Anamnese estruturada</h3>
          ...
          <article className="tc-card">
            ...
            <h3 className="mt-3 text-lg font-semibold text-tc-gray-900">Avaliação médica</h3>
            <p className="mt-2 text-sm text-tc-gray-500">
          ...
          <article className="tc-card">
            ...
            <h3 className="mt-3 text-lg font-semibold text-tc-gray-900">Acompanhamento contínuo</h3>
            <p className="mt-2 text-sm text-tc-gray-500">
