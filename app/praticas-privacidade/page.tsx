...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Conheça as práticas de privacidade da Theracorp.',
  path: '/praticas-privacidade'
});

export default function PraticasPrivacidadePage() {
  return (
      ...
      <div className="mx-auto w-full max-w-[900px] px-4 md:px-8">
        ...
        <div className="mt-10 space-y-8">
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Nosso Compromisso com a Privacidade</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">A Theracorp está comprometida em proteger a privacidade e a segurança das informações pessoais de todos os nossos usuários.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Coleta de Dados</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Coletamos apenas os dados necessários para prestar nossos serviços de telemedicina.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Armazenamento e Segurança</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Seus dados são armazenados em servidores seguros com criptografia de ponta a ponta.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Compartilhamento de Dados</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Não compartilhamos seus dados pessoais com terceiros sem seu consentimento.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Seus Direitos</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Você tem direito a acessar, corrigir, excluir e portar seus dados pessoais.</p>
          </div>
        </div>
      </div>
