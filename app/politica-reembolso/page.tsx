...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Conheça a política de reembolso da Theracorp.',
      ...
      <div className="mx-auto w-full max-w-[900px] px-4 md:px-8">
        ...
        <div className="mt-10 space-y-8">
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Política de Cancelamento</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Esta política descreve os termos de cancelamento e reembolso.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Consultas Médicas</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Taxas de consulta não são reembolsáveis após a realização.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Planos de Assinatura</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Você pode cancelar sua assinatura a qualquer momento.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Medicamentos</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Não aceitamos devoluções de medicamentos prescritos.</p>
          </div>
          <div className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Como Solicitar</h2>
            <p className="content-2 mt-3 text-sm text-tc-gray-500">Para solicitar um reembolso, entre em contato conosco.</p>
          </div>
        </div>
      </div>
