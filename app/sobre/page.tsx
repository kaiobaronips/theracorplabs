  ...
  return (
    <section className="tc-section-wrapper py-16 md:py-20">
      <div className="mx-auto w-full max-w-[900px] px-4 md:px-8">
        <h1 className="header-1 text-4xl font-bold leading-tight tracking-[-0.02em] text-tc-gray-900 md:text-5xl">Sobre a Theracorp</h1>
        ...
        <div className="mt-8 tc-card">
          <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Compromissos institucionais</h2>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          ...
          <Link href="/como-funciona" className="content-2 text-sm text-tc-gray-500 underline-offset-2 hover:text-tc-gray-900 hover:underline">Ver como funciona</Link>
        </div>
      </div>
    </section>
  );
