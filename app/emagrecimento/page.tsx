  ...
  return (
    <section className="tc-section-wrapper py-16 md:py-20">
      <div className="mx-auto w-full max-w-[900px] px-4 md:px-8">
        <h1 className="header-1 text-4xl font-bold leading-tight tracking-[-0.02em] text-tc-gray-900 md:text-5xl">Emagrecimento</h1>
        ...
        <div className="mt-8 grid gap-4">
          <article className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Critérios de elegibilidade</h2>
          ...
          <article className="tc-card">
            <h2 className="content-1 text-xl font-semibold text-tc-gray-900">Acompanhamento de resposta</h2>
            <p className="content-2 mt-2 text-sm text-tc-gray-500">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          ...
          <Link href="/exames" className="content-2 text-sm text-tc-gray-500 underline-offset-2 hover:text-tc-gray-900 hover:underline">Ver exames relacionados</Link>
        </div>
