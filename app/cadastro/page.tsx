  ...
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto w-full max-w-[720px] px-4 md:px-8">
        <h1 className="text-4xl font-bold leading-tight tracking-[-0.02em] text-tc-gray-900">Cadastro</h1>
        <p className="mt-4 text-tc-gray-500">
        ...
        <form className="mt-8 grid gap-4 tc-card" aria-label="Formulário de cadastro">
          <div>
            <label htmlFor="nome" className="mb-1 block text-sm font-medium text-tc-gray-900">Nome completo</label>
            <input id="nome" className="tc-input" type="text" autoComplete="name" required />
          </div>
          <div>
            <label htmlFor="email" className="mb-1 block text-sm font-medium text-tc-gray-900">E-mail</label>
            <input id="email" className="tc-input" type="email" autoComplete="email" required />
          </div>
          <div>
            <label htmlFor="telefone" className="mb-1 block text-sm font-medium text-tc-gray-900">Telefone</label>
            <input id="telefone" className="tc-input" type="tel" autoComplete="tel" required />
          </div>
          <div>
            <label htmlFor="objetivo" className="mb-1 block text-sm font-medium text-tc-gray-900">Objetivo principal</label>
